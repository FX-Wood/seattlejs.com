...
export const websiteEvent = {
    ...
    "date": "2023-06-14",
    "sponsors": ["courier"],
    "talks": ["cristina-rodriguez-june-2023", "aiden-bai-june-2023", "dm-liao-june-2023"],
...
export const targetEvent = { website: websiteEvent, airtable: airtableEvent as Record<FieldSet> }
...
const dm = new MockRecord({
    ...
    "fields": {
      ...
      "Talk Title": "Using the web to make interactive fanfiction (working title)",
      "Website": "https://amorphic.space",
      "Company": "Not really applicable to this...(also sorry for the non-photo, I have like no photos of myself right now)",
      "Topics": "preactjs, inkjs, immutable data, text parsing, interactive fiction",
      "Pronouns": "they/them/theirs",
      "Talk Blurb": "Over the pandemic, people developed a wide variety of hobbies to fill the time, and for me, that was writing a ridiculous amount of fanfiction. One of the most ambitious pieces was an interactive, choice-based and animated story written using Ink and 'set' with Preact and InkJS, and this talk goes through some of the creative and technical decisions I made to get them to play nicely with each other.",
      "Events": [
        "recHF8UdRhXHAvJXu"
      ],
...
const aiden = new MockRecord({
    ...
    "fields": {
      ...
      "Topics": "reactjs, millionjs, nextjs, performance, rendering, javascript, typescript",
      "Pronouns": "he/him/his",
